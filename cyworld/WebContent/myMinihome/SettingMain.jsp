...
<iframe id="frame" src="<%=request.getContextPath()%>/myMinihome/SettingMain1.jsp"
...
<div id="cg1"><a id="c1" href = "<%=request.getContextPath()%>/myMinihome/miniHomeMain.jsp">홈</a></div>
<div id="cg2"><a id="c2" href = "<%=request.getContextPath()%>/myMinihome/boardMain.jsp">게시판</a><br></div>
<div id="cg3"><a id="c3" href = "<%=request.getContextPath()%>/myMinihome/photoMain.jsp">사진첩</a><br></div>
<div id="cg4"><a id="c4" href = "<%=request.getContextPath()%>/myMinihome/guestMain.jsp">방명록</a><br></div>
