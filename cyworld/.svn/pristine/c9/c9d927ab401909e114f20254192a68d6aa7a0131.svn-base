...
public interface IFriendService {
	 ...
	 * @return 작업성공 : 1이상, 작업실패 : 0
	 */
	public int acceptFriend(MemberFriendVO memberFriendVO);
	 ...
	 * @return 작업성공 : 1이상, 작업실패 : 0
	 */
	public int deleteAccept(MemberFriendVO memberFriendVO);
